...
/datum/interaction/lewd/kiss/display_interaction(mob/living/user, mob/living/partner)
	if(user.get_lust() >= 3)
		user.visible_message("<span class='lewd'><b>[user]</b> интенсивно и продолжительно целует <b>[partner]</b>.</span>")
		//user.visible_message("<span class='lewd'>\The <b>[user]</b> gives an intense, lingering kiss to \the <b>[partner]</b>.</span>")
	else
		user.visible_message("<span class='lewd'>\The <b>[user]</b> сливается в поцелуе с <b>[partner]</b>.</span>")
